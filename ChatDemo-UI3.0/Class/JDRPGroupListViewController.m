...
@interface JDRPGroupListViewController ()<UISearchBarDelegate, UISearchDisplayDelegate, EMGroupManagerDelegate, SRRefreshDelegate>
...
@implementation JDRPGroupListViewController
...
- (EMSearchDisplayController *)searchController
{
    if (_searchController == nil) {
        ...
        __weak JDRPGroupListViewController *weakSelf = self;
        ...
        [_searchController setDidSelectRowAtIndexPathCompletion:^(UITableView *tableView, NSIndexPath *indexPath) {
            ...
            JDRPChatViewController *chatVC = [[JDRPChatViewController alloc]
#else
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    [tableView deselectRowAtIndexPath:indexPath animated:YES];
    EMGroup *group = [self.dataSource objectAtIndex:indexPath.row];
//    JDRPChatViewController *chatController = [[JDRPChatViewController alloc] initWithConversationChatter:group.groupId
//                                                                                        conversationType:EMConversationTypeGroupChat];
//    chatController.title = group.subject;
//        [self.navigationController pushViewController:chatController animated:YES];
    if(self.delegate && [self.delegate respondsToSelector:@selector(groupListViewControllerDidSelected:)])
    {
        [self.delegate groupListViewControllerDidSelected:group];
    }
}
